...
@configclass
class AresYYYv2lStudentParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
...
@configclass
class AresYYYv2lStudentParkourEnvCfg_EVAL(AresYYYv2lStudentParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class AresYYYv2lStudentParkourEnvCfg_PLAY(AresYYYv2lStudentParkourEnvCfg_EVAL):
