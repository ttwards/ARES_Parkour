...
@configclass
class AresYYYv2StudentParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
...
@configclass
class AresYYYv2StudentParkourEnvCfg_EVAL(AresYYYv2StudentParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class AresYYYv2StudentParkourEnvCfg_PLAY(AresYYYv2StudentParkourEnvCfg_EVAL):
