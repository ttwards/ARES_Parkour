...
@configclass
class AresYYYv1StudentParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
...
@configclass
class AresYYYv1StudentParkourEnvCfg_EVAL(AresYYYv1StudentParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class AresYYYv1StudentParkourEnvCfg_PLAY(AresYYYv1StudentParkourEnvCfg_EVAL):
