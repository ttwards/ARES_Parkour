from parkour_tasks.extreme_parkour_task.config.yyy_v1.agents.parkour_rl_cfg import (
...
@configclass
class AresYYYv1ParkourTeacherPPORunnerCfg(ParkourRslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 50000
    save_interval = 100
    experiment_name = "ares_yyy_v1_parkour"
